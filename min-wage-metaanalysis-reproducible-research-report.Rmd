...
Similarly, our analysis suggests the same dependence between the standard error and elasticity as in the original research [@card1995time] as seen on Figure 4. After adding studies selected by us, the positive dependence between these two statistics holds. As there should be no dependence between standard errors and the t-statistic, we can conclude that the old as well as newly added publications were biased.
